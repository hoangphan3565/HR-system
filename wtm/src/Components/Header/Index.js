...
const MenuBar = (props) => {
  ...
  const [marginLeft, setMarginLeft] = useState(
    localStorage.getItem("marginLeft")
  );
  const changeTheme = () => {
        ...
        render={() => (
          <Menu mode="horizontal">
            ...
            <SubMenu key="sub1" icon={<AppstoreOutlined />} title="Infomations">
              <Menu.Item key="3">
                <Link to="/employee" style={{ color: "blue" }}>
                  Employees
                </Link>
              </Menu.Item>
              <Menu.Item key="4" icon={<ApartmentOutlined />}>
                <Link to="/department" style={{ color: "blue" }}>
                  Departments
                </Link>
              </Menu.Item>
              <Menu.Item key="5">
                <Link to="/empshift" style={{ color: "blue" }}>
                  Working Shift Management
                </Link>
              </Menu.Item>
              <Menu.Item key="6">
                <Link to="/position" style={{ color: "blue" }}>
                  Positions
                </Link>
              </Menu.Item>
            </SubMenu>
            <SubMenu key="sub2" icon={<CalendarOutlined />} title="Date">
              <Menu.Item key="7">
                <Link to="/holidays" style={{ color: "blue" }}>
                  Holidays
                </Link>
              </Menu.Item>
        ...
        render={() => (
          <div>
            ...
            <Menu
              ...
              style={{
                backgroundColor: theme === "light" ? "aliceblue" : "#1f1f1f",
                width: size,
              }}
            >
              ...
              <SubMenu key="sub2" icon={<CalendarOutlined />} title="Date">
                ...
                <Menu.Item key="10" icon={<CalendarOutlined />}>
                  <Link to="/timekeepings">TimeKeeping</Link>
                </Menu.Item>
                <Menu.Item key="8" icon={<SplitCellsOutlined />}>
                  Leave
                </Menu.Item>
                ...
                <Menu.Item key="11" icon={<CalendarOutlined />}>
                  <Link to="/dailyschedules">Daily Schedules</Link>
                </Menu.Item>
              ...
              >
                ...
                <Menu.Item key="5" icon={<AuditOutlined />}>
                  <Link to="/empshift">Working Shift Management</Link>
                </Menu.Item>
